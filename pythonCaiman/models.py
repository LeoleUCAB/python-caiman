...
class Pizza(models.Model):
    primaryKey = models.DecimalField(primary_key= True, decimal_places= 0, max_digits= 2)
    ...
    ingredient_fk = models.ForeignKey('Ingredient', models.DO_NOTHING, db_column='ingredient_fk')
